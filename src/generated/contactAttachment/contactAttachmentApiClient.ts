 ...
 */
export interface ContactAttachmentApiClient extends BaseRequestBuilder<ContactAttachmentApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link ContactAttachmentApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createContactAttachmentApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<ContactAttachmentApiClient>(requestAdapter, pathParameters, ContactAttachmentApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const ContactAttachmentApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const ContactAttachmentApiClientNavigationMetadata: Record<Exclude<keyof ContactAttachmentApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
