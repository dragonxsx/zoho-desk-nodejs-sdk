 ...
 */
export interface CommunityUserApiClient extends BaseRequestBuilder<CommunityUserApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link CommunityUserApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createCommunityUserApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<CommunityUserApiClient>(requestAdapter, pathParameters, CommunityUserApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const CommunityUserApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const CommunityUserApiClientNavigationMetadata: Record<Exclude<keyof CommunityUserApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
