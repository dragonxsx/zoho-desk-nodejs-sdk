 ...
 */
export interface ContractApiClient extends BaseRequestBuilder<ContractApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link ContractApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createContractApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<ContractApiClient>(requestAdapter, pathParameters, ContractApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const ContractApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const ContractApiClientNavigationMetadata: Record<Exclude<keyof ContractApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
