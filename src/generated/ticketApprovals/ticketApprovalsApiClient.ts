...
/**
 * Instantiates a new {@link TicketApprovalsApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createTicketApprovalsApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<TicketApprovalsApiClient>(requestAdapter, pathParameters, TicketApprovalsApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface TicketApprovalsApiClient extends BaseRequestBuilder<TicketApprovalsApiClient> {
    /**
     * The api property
     */
 ...
 */
export const TicketApprovalsApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const TicketApprovalsApiClientNavigationMetadata: Record<Exclude<keyof TicketApprovalsApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
