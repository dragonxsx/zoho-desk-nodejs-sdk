...
// @ts-ignore
import { RoutingPreferencesRequestBuilderRequestsMetadata, type RoutingPreferencesRequestBuilder } from './routingPreferences/index.js';
// @ts-ignore
...
export interface V1RequestBuilder extends BaseRequestBuilder<V1RequestBuilder> {
    /**
     * The routingPreferences property
     */
    get routingPreferences(): RoutingPreferencesRequestBuilder;
}
/**
...
export const V1RequestBuilderNavigationMetadata: Record<Exclude<keyof V1RequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    routingPreferences: {
        requestsMetadata: RoutingPreferencesRequestBuilderRequestsMetadata,
    },
};
/* tslint:enable */
/* eslint-enable */
