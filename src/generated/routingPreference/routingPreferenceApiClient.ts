...
/**
 * Instantiates a new {@link RoutingPreferenceApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createRoutingPreferenceApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<RoutingPreferenceApiClient>(requestAdapter, pathParameters, RoutingPreferenceApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface RoutingPreferenceApiClient extends BaseRequestBuilder<RoutingPreferenceApiClient> {
    /**
     * The api property
     */
 ...
 */
export const RoutingPreferenceApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const RoutingPreferenceApiClientNavigationMetadata: Record<Exclude<keyof RoutingPreferenceApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
