...
/**
 * Instantiates a new {@link TaskTimeEntryApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createTaskTimeEntryApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<TaskTimeEntryApiClient>(requestAdapter, pathParameters, TaskTimeEntryApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface TaskTimeEntryApiClient extends BaseRequestBuilder<TaskTimeEntryApiClient> {
    /**
     * The api property
     */
 ...
 */
export const TaskTimeEntryApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const TaskTimeEntryApiClientNavigationMetadata: Record<Exclude<keyof TaskTimeEntryApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
