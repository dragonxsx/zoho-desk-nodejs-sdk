 ...
 */
export interface CallCommentsApiClient extends BaseRequestBuilder<CallCommentsApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link CallCommentsApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createCallCommentsApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<CallCommentsApiClient>(requestAdapter, pathParameters, CallCommentsApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const CallCommentsApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const CallCommentsApiClientNavigationMetadata: Record<Exclude<keyof CallCommentsApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
