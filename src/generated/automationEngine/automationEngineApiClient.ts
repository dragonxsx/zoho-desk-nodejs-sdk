 ...
 */
export interface AutomationEngineApiClient extends BaseRequestBuilder<AutomationEngineApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link AutomationEngineApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createAutomationEngineApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<AutomationEngineApiClient>(requestAdapter, pathParameters, AutomationEngineApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const AutomationEngineApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const AutomationEngineApiClientNavigationMetadata: Record<Exclude<keyof AutomationEngineApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
