...
/**
 * Instantiates a new {@link HelpcenterApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createHelpcenterApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<HelpcenterApiClient>(requestAdapter, pathParameters, HelpcenterApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface HelpcenterApiClient extends BaseRequestBuilder<HelpcenterApiClient> {
    /**
     * The api property
     */
 ...
 */
export const HelpcenterApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const HelpcenterApiClientNavigationMetadata: Record<Exclude<keyof HelpcenterApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
