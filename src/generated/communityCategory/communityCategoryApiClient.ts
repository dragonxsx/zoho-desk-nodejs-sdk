 ...
 */
export interface CommunityCategoryApiClient extends BaseRequestBuilder<CommunityCategoryApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link CommunityCategoryApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createCommunityCategoryApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<CommunityCategoryApiClient>(requestAdapter, pathParameters, CommunityCategoryApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const CommunityCategoryApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const CommunityCategoryApiClientNavigationMetadata: Record<Exclude<keyof CommunityCategoryApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
