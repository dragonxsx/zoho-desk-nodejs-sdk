...
/**
 * Instantiates a new {@link LayoutRulesApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createLayoutRulesApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<LayoutRulesApiClient>(requestAdapter, pathParameters, LayoutRulesApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface LayoutRulesApiClient extends BaseRequestBuilder<LayoutRulesApiClient> {
    /**
     * The api property
     */
 ...
 */
export const LayoutRulesApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const LayoutRulesApiClientNavigationMetadata: Record<Exclude<keyof LayoutRulesApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
