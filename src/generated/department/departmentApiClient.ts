...
/**
 * Instantiates a new {@link DepartmentApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createDepartmentApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<DepartmentApiClient>(requestAdapter, pathParameters, DepartmentApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface DepartmentApiClient extends BaseRequestBuilder<DepartmentApiClient> {
    /**
     * The api property
     */
 ...
 */
export const DepartmentApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const DepartmentApiClientNavigationMetadata: Record<Exclude<keyof DepartmentApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
