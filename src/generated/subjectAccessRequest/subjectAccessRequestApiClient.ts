...
/**
 * Instantiates a new {@link SubjectAccessRequestApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createSubjectAccessRequestApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<SubjectAccessRequestApiClient>(requestAdapter, pathParameters, SubjectAccessRequestApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface SubjectAccessRequestApiClient extends BaseRequestBuilder<SubjectAccessRequestApiClient> {
    /**
     * The api property
     */
 ...
 */
export const SubjectAccessRequestApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const SubjectAccessRequestApiClientNavigationMetadata: Record<Exclude<keyof SubjectAccessRequestApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
