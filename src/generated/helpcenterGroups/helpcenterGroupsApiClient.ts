...
/**
 * Instantiates a new {@link HelpcenterGroupsApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createHelpcenterGroupsApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<HelpcenterGroupsApiClient>(requestAdapter, pathParameters, HelpcenterGroupsApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface HelpcenterGroupsApiClient extends BaseRequestBuilder<HelpcenterGroupsApiClient> {
    /**
     * The api property
     */
 ...
 */
export const HelpcenterGroupsApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const HelpcenterGroupsApiClientNavigationMetadata: Record<Exclude<keyof HelpcenterGroupsApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
