...
/**
 * Instantiates a new {@link SupportPlanApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createSupportPlanApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<SupportPlanApiClient>(requestAdapter, pathParameters, SupportPlanApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface SupportPlanApiClient extends BaseRequestBuilder<SupportPlanApiClient> {
    /**
     * The api property
     */
 ...
 */
export const SupportPlanApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const SupportPlanApiClientNavigationMetadata: Record<Exclude<keyof SupportPlanApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
