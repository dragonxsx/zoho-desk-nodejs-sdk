...
/**
 * Instantiates a new {@link DisplayEntityApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createDisplayEntityApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<DisplayEntityApiClient>(requestAdapter, pathParameters, DisplayEntityApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface DisplayEntityApiClient extends BaseRequestBuilder<DisplayEntityApiClient> {
    /**
     * The api property
     */
 ...
 */
export const DisplayEntityApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const DisplayEntityApiClientNavigationMetadata: Record<Exclude<keyof DisplayEntityApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
