...
/**
 * Instantiates a new {@link ModuleApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createModuleApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<ModuleApiClient>(requestAdapter, pathParameters, ModuleApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface ModuleApiClient extends BaseRequestBuilder<ModuleApiClient> {
    /**
     * The api property
     */
 ...
 */
export const ModuleApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const ModuleApiClientNavigationMetadata: Record<Exclude<keyof ModuleApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
