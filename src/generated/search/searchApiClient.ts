...
/**
 * Instantiates a new {@link SearchApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createSearchApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<SearchApiClient>(requestAdapter, pathParameters, SearchApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface SearchApiClient extends BaseRequestBuilder<SearchApiClient> {
    /**
     * The api property
     */
 ...
 */
export const SearchApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const SearchApiClientNavigationMetadata: Record<Exclude<keyof SearchApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
