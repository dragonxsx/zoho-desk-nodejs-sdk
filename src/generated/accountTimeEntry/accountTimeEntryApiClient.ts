 ...
 */
export interface AccountTimeEntryApiClient extends BaseRequestBuilder<AccountTimeEntryApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link AccountTimeEntryApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createAccountTimeEntryApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<AccountTimeEntryApiClient>(requestAdapter, pathParameters, AccountTimeEntryApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const AccountTimeEntryApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const AccountTimeEntryApiClientNavigationMetadata: Record<Exclude<keyof AccountTimeEntryApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
