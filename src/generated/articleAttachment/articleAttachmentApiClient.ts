 ...
 */
export interface ArticleAttachmentApiClient extends BaseRequestBuilder<ArticleAttachmentApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link ArticleAttachmentApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createArticleAttachmentApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<ArticleAttachmentApiClient>(requestAdapter, pathParameters, ArticleAttachmentApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const ArticleAttachmentApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const ArticleAttachmentApiClientNavigationMetadata: Record<Exclude<keyof ArticleAttachmentApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
