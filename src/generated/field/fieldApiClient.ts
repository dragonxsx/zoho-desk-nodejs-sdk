...
/**
 * Instantiates a new {@link FieldApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createFieldApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<FieldApiClient>(requestAdapter, pathParameters, FieldApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface FieldApiClient extends BaseRequestBuilder<FieldApiClient> {
    /**
     * The api property
     */
 ...
 */
export const FieldApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const FieldApiClientNavigationMetadata: Record<Exclude<keyof FieldApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
