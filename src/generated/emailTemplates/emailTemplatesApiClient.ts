...
/**
 * Instantiates a new {@link EmailTemplatesApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createEmailTemplatesApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<EmailTemplatesApiClient>(requestAdapter, pathParameters, EmailTemplatesApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface EmailTemplatesApiClient extends BaseRequestBuilder<EmailTemplatesApiClient> {
    /**
     * The api property
     */
 ...
 */
export const EmailTemplatesApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const EmailTemplatesApiClientNavigationMetadata: Record<Exclude<keyof EmailTemplatesApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
