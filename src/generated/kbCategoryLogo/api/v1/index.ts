...
// @ts-ignore
import { KbCategoryLogoRequestBuilderRequestsMetadata, type KbCategoryLogoRequestBuilder } from './kbCategoryLogo/index.js';
// @ts-ignore
...
export interface V1RequestBuilder extends BaseRequestBuilder<V1RequestBuilder> {
    /**
     * The kbCategoryLogo property
     */
    get kbCategoryLogo(): KbCategoryLogoRequestBuilder;
}
/**
...
export const V1RequestBuilderNavigationMetadata: Record<Exclude<keyof V1RequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    kbCategoryLogo: {
        requestsMetadata: KbCategoryLogoRequestBuilderRequestsMetadata,
    },
};
/* tslint:enable */
/* eslint-enable */
