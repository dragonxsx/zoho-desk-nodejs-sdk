...
/**
 * Instantiates a new {@link KbCategoryLogoApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createKbCategoryLogoApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<KbCategoryLogoApiClient>(requestAdapter, pathParameters, KbCategoryLogoApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface KbCategoryLogoApiClient extends BaseRequestBuilder<KbCategoryLogoApiClient> {
    /**
     * The api property
     */
 ...
 */
export const KbCategoryLogoApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const KbCategoryLogoApiClientNavigationMetadata: Record<Exclude<keyof KbCategoryLogoApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
