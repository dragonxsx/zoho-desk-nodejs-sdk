...
/**
 * Builds and executes requests for operations under /api/v1/agents/count
 */
 ...
 */
export const CountRequestBuilderUriTemplate = "{+baseurl}/api/v1/agents/count?orgId={orgId}{&includeLightAgent*,isConfirmed*,status*}";
/**
