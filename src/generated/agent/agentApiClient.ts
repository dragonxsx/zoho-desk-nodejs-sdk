 ...
 */
export interface AgentApiClient extends BaseRequestBuilder<AgentApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link AgentApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createAgentApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<AgentApiClient>(requestAdapter, pathParameters, AgentApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const AgentApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const AgentApiClientNavigationMetadata: Record<Exclude<keyof AgentApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
