...
/**
 * Instantiates a new {@link KBRootCategoryApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createKBRootCategoryApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<KBRootCategoryApiClient>(requestAdapter, pathParameters, KBRootCategoryApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface KBRootCategoryApiClient extends BaseRequestBuilder<KBRootCategoryApiClient> {
    /**
     * The api property
     */
 ...
 */
export const KBRootCategoryApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const KBRootCategoryApiClientNavigationMetadata: Record<Exclude<keyof KBRootCategoryApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
