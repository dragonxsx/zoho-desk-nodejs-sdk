...
// @ts-ignore
import { type WidgetsRequestBuilder, WidgetsRequestBuilderNavigationMetadata } from './widgets/index.js';
// @ts-ignore
...
export interface V1RequestBuilder extends BaseRequestBuilder<V1RequestBuilder> {
     ...
     */
    get widgets(): WidgetsRequestBuilder;
}
/**
...
export const V1RequestBuilderNavigationMetadata: Record<Exclude<keyof V1RequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    widgets: {
        navigationMetadata: WidgetsRequestBuilderNavigationMetadata,
    },
};
/* tslint:enable */
/* eslint-enable */
