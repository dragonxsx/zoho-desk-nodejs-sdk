...
/**
 * Instantiates a new {@link WidgetApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createWidgetApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<WidgetApiClient>(requestAdapter, pathParameters, WidgetApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface WidgetApiClient extends BaseRequestBuilder<WidgetApiClient> {
    /**
     * The api property
     */
 ...
 */
export const WidgetApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const WidgetApiClientNavigationMetadata: Record<Exclude<keyof WidgetApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
