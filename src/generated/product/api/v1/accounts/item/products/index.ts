...
/**
 * Builds and executes requests for operations under /api/v1/accounts/{accountId}/products
 */
 ...
 */
export const ProductsRequestBuilderUriTemplate = "{+baseurl}/api/v1/accounts/{accountId}/products?orgId={orgId}{&departmentId*,from*,limit*}";
/**
