...
/**
 * Instantiates a new {@link ProductApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createProductApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<ProductApiClient>(requestAdapter, pathParameters, ProductApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface ProductApiClient extends BaseRequestBuilder<ProductApiClient> {
    /**
     * The api property
     */
 ...
 */
export const ProductApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const ProductApiClientNavigationMetadata: Record<Exclude<keyof ProductApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
