...
/**
 * Instantiates a new {@link ThreadApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createThreadApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<ThreadApiClient>(requestAdapter, pathParameters, ThreadApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface ThreadApiClient extends BaseRequestBuilder<ThreadApiClient> {
    /**
     * The api property
     */
 ...
 */
export const ThreadApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const ThreadApiClientNavigationMetadata: Record<Exclude<keyof ThreadApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
