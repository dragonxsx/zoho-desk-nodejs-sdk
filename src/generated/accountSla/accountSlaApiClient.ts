 ...
 */
export interface AccountSlaApiClient extends BaseRequestBuilder<AccountSlaApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link AccountSlaApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createAccountSlaApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<AccountSlaApiClient>(requestAdapter, pathParameters, AccountSlaApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const AccountSlaApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const AccountSlaApiClientNavigationMetadata: Record<Exclude<keyof AccountSlaApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
