 ...
 */
export interface BusinessHourApiClient extends BaseRequestBuilder<BusinessHourApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link BusinessHourApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createBusinessHourApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<BusinessHourApiClient>(requestAdapter, pathParameters, BusinessHourApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const BusinessHourApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const BusinessHourApiClientNavigationMetadata: Record<Exclude<keyof BusinessHourApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
