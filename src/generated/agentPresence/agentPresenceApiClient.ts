 ...
 */
export interface AgentPresenceApiClient extends BaseRequestBuilder<AgentPresenceApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link AgentPresenceApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createAgentPresenceApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<AgentPresenceApiClient>(requestAdapter, pathParameters, AgentPresenceApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const AgentPresenceApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const AgentPresenceApiClientNavigationMetadata: Record<Exclude<keyof AgentPresenceApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
