...
/**
 * Instantiates a new {@link TicketFollowersApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createTicketFollowersApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<TicketFollowersApiClient>(requestAdapter, pathParameters, TicketFollowersApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface TicketFollowersApiClient extends BaseRequestBuilder<TicketFollowersApiClient> {
    /**
     * The api property
     */
 ...
 */
export const TicketFollowersApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const TicketFollowersApiClientNavigationMetadata: Record<Exclude<keyof TicketFollowersApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
