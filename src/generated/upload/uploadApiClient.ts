...
/**
 * Instantiates a new {@link UploadApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createUploadApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<UploadApiClient>(requestAdapter, pathParameters, UploadApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface UploadApiClient extends BaseRequestBuilder<UploadApiClient> {
    /**
     * The api property
     */
 ...
 */
export const UploadApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const UploadApiClientNavigationMetadata: Record<Exclude<keyof UploadApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
