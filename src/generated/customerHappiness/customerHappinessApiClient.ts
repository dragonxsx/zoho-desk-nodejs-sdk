...
/**
 * Instantiates a new {@link CustomerHappinessApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createCustomerHappinessApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<CustomerHappinessApiClient>(requestAdapter, pathParameters, CustomerHappinessApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface CustomerHappinessApiClient extends BaseRequestBuilder<CustomerHappinessApiClient> {
    /**
     * The api property
     */
 ...
 */
export const CustomerHappinessApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const CustomerHappinessApiClientNavigationMetadata: Record<Exclude<keyof CustomerHappinessApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
