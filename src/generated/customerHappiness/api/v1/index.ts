...
// @ts-ignore
import { CustomerHappinessLinkHolderRequestBuilderRequestsMetadata, type CustomerHappinessLinkHolderRequestBuilder } from './customerHappinessLinkHolder/index.js';
// @ts-ignore
...
export interface V1RequestBuilder extends BaseRequestBuilder<V1RequestBuilder> {
    /**
     * The customerHappinessLinkHolder property
     */
    get customerHappinessLinkHolder(): CustomerHappinessLinkHolderRequestBuilder;
}
/**
...
export const V1RequestBuilderNavigationMetadata: Record<Exclude<keyof V1RequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    customerHappinessLinkHolder: {
        requestsMetadata: CustomerHappinessLinkHolderRequestBuilderRequestsMetadata,
    },
};
/* tslint:enable */
/* eslint-enable */
