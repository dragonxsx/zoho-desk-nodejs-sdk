...
/**
 * Instantiates a new {@link IMCannedMessageApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createIMCannedMessageApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<IMCannedMessageApiClient>(requestAdapter, pathParameters, IMCannedMessageApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface IMCannedMessageApiClient extends BaseRequestBuilder<IMCannedMessageApiClient> {
    /**
     * The api property
     */
 ...
 */
export const IMCannedMessageApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const IMCannedMessageApiClientNavigationMetadata: Record<Exclude<keyof IMCannedMessageApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
