 ...
 */
export interface ActivityApiClient extends BaseRequestBuilder<ActivityApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link ActivityApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createActivityApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<ActivityApiClient>(requestAdapter, pathParameters, ActivityApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const ActivityApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const ActivityApiClientNavigationMetadata: Record<Exclude<keyof ActivityApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
