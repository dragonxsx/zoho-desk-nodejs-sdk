...
/**
 * Instantiates a new {@link EmailFailureAlertApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createEmailFailureAlertApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<EmailFailureAlertApiClient>(requestAdapter, pathParameters, EmailFailureAlertApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface EmailFailureAlertApiClient extends BaseRequestBuilder<EmailFailureAlertApiClient> {
    /**
     * The api property
     */
 ...
 */
export const EmailFailureAlertApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const EmailFailureAlertApiClientNavigationMetadata: Record<Exclude<keyof EmailFailureAlertApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
