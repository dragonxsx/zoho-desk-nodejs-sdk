 ...
 */
export interface AccountApiClient extends BaseRequestBuilder<AccountApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link AccountApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createAccountApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<AccountApiClient>(requestAdapter, pathParameters, AccountApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const AccountApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const AccountApiClientNavigationMetadata: Record<Exclude<keyof AccountApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
