 ...
 */
export interface AccountCommentsApiClient extends BaseRequestBuilder<AccountCommentsApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link AccountCommentsApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createAccountCommentsApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<AccountCommentsApiClient>(requestAdapter, pathParameters, AccountCommentsApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const AccountCommentsApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const AccountCommentsApiClientNavigationMetadata: Record<Exclude<keyof AccountCommentsApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
