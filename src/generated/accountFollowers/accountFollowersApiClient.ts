 ...
 */
export interface AccountFollowersApiClient extends BaseRequestBuilder<AccountFollowersApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link AccountFollowersApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createAccountFollowersApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<AccountFollowersApiClient>(requestAdapter, pathParameters, AccountFollowersApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const AccountFollowersApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const AccountFollowersApiClientNavigationMetadata: Record<Exclude<keyof AccountFollowersApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
