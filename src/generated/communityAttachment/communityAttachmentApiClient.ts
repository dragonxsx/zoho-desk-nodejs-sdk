 ...
 */
export interface CommunityAttachmentApiClient extends BaseRequestBuilder<CommunityAttachmentApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link CommunityAttachmentApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createCommunityAttachmentApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<CommunityAttachmentApiClient>(requestAdapter, pathParameters, CommunityAttachmentApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const CommunityAttachmentApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const CommunityAttachmentApiClientNavigationMetadata: Record<Exclude<keyof CommunityAttachmentApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
