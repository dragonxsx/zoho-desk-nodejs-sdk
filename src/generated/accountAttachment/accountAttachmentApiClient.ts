 ...
 */
export interface AccountAttachmentApiClient extends BaseRequestBuilder<AccountAttachmentApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link AccountAttachmentApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createAccountAttachmentApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<AccountAttachmentApiClient>(requestAdapter, pathParameters, AccountAttachmentApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const AccountAttachmentApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const AccountAttachmentApiClientNavigationMetadata: Record<Exclude<keyof AccountAttachmentApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
