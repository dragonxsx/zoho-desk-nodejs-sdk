...
/**
 * Instantiates a new {@link TicketAttachmentApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createTicketAttachmentApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<TicketAttachmentApiClient>(requestAdapter, pathParameters, TicketAttachmentApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface TicketAttachmentApiClient extends BaseRequestBuilder<TicketAttachmentApiClient> {
    /**
     * The api property
     */
 ...
 */
export const TicketAttachmentApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const TicketAttachmentApiClientNavigationMetadata: Record<Exclude<keyof TicketAttachmentApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
