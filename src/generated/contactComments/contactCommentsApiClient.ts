 ...
 */
export interface ContactCommentsApiClient extends BaseRequestBuilder<ContactCommentsApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link ContactCommentsApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createContactCommentsApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<ContactCommentsApiClient>(requestAdapter, pathParameters, ContactCommentsApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const ContactCommentsApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const ContactCommentsApiClientNavigationMetadata: Record<Exclude<keyof ContactCommentsApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
