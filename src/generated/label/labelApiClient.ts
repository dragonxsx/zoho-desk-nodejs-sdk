...
/**
 * Instantiates a new {@link LabelApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createLabelApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<LabelApiClient>(requestAdapter, pathParameters, LabelApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface LabelApiClient extends BaseRequestBuilder<LabelApiClient> {
    /**
     * The api property
     */
 ...
 */
export const LabelApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const LabelApiClientNavigationMetadata: Record<Exclude<keyof LabelApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
