...
/**
 * Instantiates a new {@link PinnedConversationApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createPinnedConversationApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<PinnedConversationApiClient>(requestAdapter, pathParameters, PinnedConversationApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface PinnedConversationApiClient extends BaseRequestBuilder<PinnedConversationApiClient> {
    /**
     * The api property
     */
 ...
 */
export const PinnedConversationApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const PinnedConversationApiClientNavigationMetadata: Record<Exclude<keyof PinnedConversationApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
