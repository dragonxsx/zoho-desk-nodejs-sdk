...
// @ts-ignore
import { BulkImportRequestBuilderNavigationMetadata, type BulkImportRequestBuilder } from './bulkImport/index.js';
// @ts-ignore
...
export interface V1RequestBuilder extends BaseRequestBuilder<V1RequestBuilder> {
    /**
     * The bulkImport property
     */
    get bulkImport(): BulkImportRequestBuilder;
}
/**
...
export const V1RequestBuilderNavigationMetadata: Record<Exclude<keyof V1RequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    bulkImport: {
        navigationMetadata: BulkImportRequestBuilderNavigationMetadata,
    },
};
/* tslint:enable */
/* eslint-enable */
