 ...
 */
export interface BulkImportApiClient extends BaseRequestBuilder<BulkImportApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link BulkImportApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createBulkImportApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<BulkImportApiClient>(requestAdapter, pathParameters, BulkImportApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const BulkImportApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const BulkImportApiClientNavigationMetadata: Record<Exclude<keyof BulkImportApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
