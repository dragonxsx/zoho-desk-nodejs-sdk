...
/**
 * Instantiates a new {@link RuleGroupApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createRuleGroupApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<RuleGroupApiClient>(requestAdapter, pathParameters, RuleGroupApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface RuleGroupApiClient extends BaseRequestBuilder<RuleGroupApiClient> {
    /**
     * The api property
     */
 ...
 */
export const RuleGroupApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const RuleGroupApiClientNavigationMetadata: Record<Exclude<keyof RuleGroupApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
