...
/**
 * Instantiates a new {@link TaskAttachmentApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createTaskAttachmentApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<TaskAttachmentApiClient>(requestAdapter, pathParameters, TaskAttachmentApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface TaskAttachmentApiClient extends BaseRequestBuilder<TaskAttachmentApiClient> {
    /**
     * The api property
     */
 ...
 */
export const TaskAttachmentApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const TaskAttachmentApiClientNavigationMetadata: Record<Exclude<keyof TaskAttachmentApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
