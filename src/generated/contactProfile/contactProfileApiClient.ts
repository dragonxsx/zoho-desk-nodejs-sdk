 ...
 */
export interface ContactProfileApiClient extends BaseRequestBuilder<ContactProfileApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link ContactProfileApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createContactProfileApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<ContactProfileApiClient>(requestAdapter, pathParameters, ContactProfileApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const ContactProfileApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const ContactProfileApiClientNavigationMetadata: Record<Exclude<keyof ContactProfileApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
