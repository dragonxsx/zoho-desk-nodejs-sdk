...
/**
 * Instantiates a new {@link DashboardsApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createDashboardsApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<DashboardsApiClient>(requestAdapter, pathParameters, DashboardsApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface DashboardsApiClient extends BaseRequestBuilder<DashboardsApiClient> {
    /**
     * The api property
     */
 ...
 */
export const DashboardsApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const DashboardsApiClientNavigationMetadata: Record<Exclude<keyof DashboardsApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
