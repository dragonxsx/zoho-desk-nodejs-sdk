...
/**
 * Instantiates a new {@link TaskApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createTaskApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<TaskApiClient>(requestAdapter, pathParameters, TaskApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface TaskApiClient extends BaseRequestBuilder<TaskApiClient> {
    /**
     * The api property
     */
 ...
 */
export const TaskApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const TaskApiClientNavigationMetadata: Record<Exclude<keyof TaskApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
