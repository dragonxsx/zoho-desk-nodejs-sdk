...
/**
 * Instantiates a new {@link SharingRuleApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createSharingRuleApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<SharingRuleApiClient>(requestAdapter, pathParameters, SharingRuleApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface SharingRuleApiClient extends BaseRequestBuilder<SharingRuleApiClient> {
    /**
     * The api property
     */
 ...
 */
export const SharingRuleApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const SharingRuleApiClientNavigationMetadata: Record<Exclude<keyof SharingRuleApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
