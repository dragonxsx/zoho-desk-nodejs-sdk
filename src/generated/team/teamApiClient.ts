...
/**
 * Instantiates a new {@link TeamApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createTeamApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<TeamApiClient>(requestAdapter, pathParameters, TeamApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface TeamApiClient extends BaseRequestBuilder<TeamApiClient> {
    /**
     * The api property
     */
 ...
 */
export const TeamApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const TeamApiClientNavigationMetadata: Record<Exclude<keyof TeamApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
