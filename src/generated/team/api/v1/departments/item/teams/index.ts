...
/**
 * Builds and executes requests for operations under /api/v1/departments/{departmentId}/teams
 */
 ...
 */
export const TeamsRequestBuilderUriTemplate = "{+baseurl}/api/v1/departments/{departmentId}/teams?orgId={orgId}";
/**
