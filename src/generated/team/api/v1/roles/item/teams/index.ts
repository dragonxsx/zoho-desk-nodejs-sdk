...
/**
 * Builds and executes requests for operations under /api/v1/roles/{role_id}/teams
 */
 ...
 */
export const TeamsRequestBuilderUriTemplate = "{+baseurl}/api/v1/roles/{role_id}/teams?orgId={orgId}";
/**
