...
/**
 * Instantiates a new {@link DomainMappingApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createDomainMappingApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<DomainMappingApiClient>(requestAdapter, pathParameters, DomainMappingApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface DomainMappingApiClient extends BaseRequestBuilder<DomainMappingApiClient> {
    /**
     * The api property
     */
 ...
 */
export const DomainMappingApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const DomainMappingApiClientNavigationMetadata: Record<Exclude<keyof DomainMappingApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
