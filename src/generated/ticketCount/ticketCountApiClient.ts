...
/**
 * Instantiates a new {@link TicketCountApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createTicketCountApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<TicketCountApiClient>(requestAdapter, pathParameters, TicketCountApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface TicketCountApiClient extends BaseRequestBuilder<TicketCountApiClient> {
    /**
     * The api property
     */
 ...
 */
export const TicketCountApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const TicketCountApiClientNavigationMetadata: Record<Exclude<keyof TicketCountApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
