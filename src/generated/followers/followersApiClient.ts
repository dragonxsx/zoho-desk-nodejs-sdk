...
/**
 * Instantiates a new {@link FollowersApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createFollowersApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<FollowersApiClient>(requestAdapter, pathParameters, FollowersApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface FollowersApiClient extends BaseRequestBuilder<FollowersApiClient> {
    /**
     * The api property
     */
 ...
 */
export const FollowersApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const FollowersApiClientNavigationMetadata: Record<Exclude<keyof FollowersApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
