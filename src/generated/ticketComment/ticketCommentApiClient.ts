...
/**
 * Instantiates a new {@link TicketCommentApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createTicketCommentApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<TicketCommentApiClient>(requestAdapter, pathParameters, TicketCommentApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface TicketCommentApiClient extends BaseRequestBuilder<TicketCommentApiClient> {
    /**
     * The api property
     */
 ...
 */
export const TicketCommentApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const TicketCommentApiClientNavigationMetadata: Record<Exclude<keyof TicketCommentApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
