 ...
 */
export interface AgentTimeEntryApiClient extends BaseRequestBuilder<AgentTimeEntryApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link AgentTimeEntryApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createAgentTimeEntryApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<AgentTimeEntryApiClient>(requestAdapter, pathParameters, AgentTimeEntryApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const AgentTimeEntryApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const AgentTimeEntryApiClientNavigationMetadata: Record<Exclude<keyof AgentTimeEntryApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
