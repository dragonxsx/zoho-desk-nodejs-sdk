...
/**
 * Instantiates a new {@link TicketTimeEntryApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createTicketTimeEntryApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<TicketTimeEntryApiClient>(requestAdapter, pathParameters, TicketTimeEntryApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface TicketTimeEntryApiClient extends BaseRequestBuilder<TicketTimeEntryApiClient> {
    /**
     * The api property
     */
 ...
 */
export const TicketTimeEntryApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const TicketTimeEntryApiClientNavigationMetadata: Record<Exclude<keyof TicketTimeEntryApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
