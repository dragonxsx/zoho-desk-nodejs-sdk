...
/**
 * Instantiates a new {@link ImportApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createImportApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<ImportApiClient>(requestAdapter, pathParameters, ImportApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface ImportApiClient extends BaseRequestBuilder<ImportApiClient> {
    /**
     * The api property
     */
 ...
 */
export const ImportApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const ImportApiClientNavigationMetadata: Record<Exclude<keyof ImportApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
