...
/**
 * Instantiates a new {@link RecyclebinApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createRecyclebinApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<RecyclebinApiClient>(requestAdapter, pathParameters, RecyclebinApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface RecyclebinApiClient extends BaseRequestBuilder<RecyclebinApiClient> {
    /**
     * The api property
     */
 ...
 */
export const RecyclebinApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const RecyclebinApiClientNavigationMetadata: Record<Exclude<keyof RecyclebinApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
