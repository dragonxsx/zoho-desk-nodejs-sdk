 ...
 */
export interface BackupApiClient extends BaseRequestBuilder<BackupApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link BackupApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createBackupApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<BackupApiClient>(requestAdapter, pathParameters, BackupApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const BackupApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const BackupApiClientNavigationMetadata: Record<Exclude<keyof BackupApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
