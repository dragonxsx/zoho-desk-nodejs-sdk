...
/**
 * Builds and executes requests for operations under /api/v1/communityTopics/{topicId}/replies/{replyId}/attachments/{attachmentId}/content
 */
 ...
 */
export const ContentRequestBuilderUriTemplate = "{+baseurl}/api/v1/communityTopics/{topicId}/replies/{replyId}/attachments/{attachmentId}/content?orgId={orgId}";
/**
