 ...
 */
export interface CommunityApiClient extends BaseRequestBuilder<CommunityApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link CommunityApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createCommunityApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<CommunityApiClient>(requestAdapter, pathParameters, CommunityApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const CommunityApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const CommunityApiClientNavigationMetadata: Record<Exclude<keyof CommunityApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
