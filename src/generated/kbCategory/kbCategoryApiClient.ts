...
/**
 * Instantiates a new {@link KbCategoryApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createKbCategoryApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<KbCategoryApiClient>(requestAdapter, pathParameters, KbCategoryApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface KbCategoryApiClient extends BaseRequestBuilder<KbCategoryApiClient> {
    /**
     * The api property
     */
 ...
 */
export const KbCategoryApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const KbCategoryApiClientNavigationMetadata: Record<Exclude<keyof KbCategoryApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
