...
/**
 * Instantiates a new {@link DependencyMappingsApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createDependencyMappingsApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<DependencyMappingsApiClient>(requestAdapter, pathParameters, DependencyMappingsApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface DependencyMappingsApiClient extends BaseRequestBuilder<DependencyMappingsApiClient> {
    /**
     * The api property
     */
 ...
 */
export const DependencyMappingsApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const DependencyMappingsApiClientNavigationMetadata: Record<Exclude<keyof DependencyMappingsApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
