...
/**
 * Instantiates a new {@link RoleApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createRoleApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<RoleApiClient>(requestAdapter, pathParameters, RoleApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface RoleApiClient extends BaseRequestBuilder<RoleApiClient> {
    /**
     * The api property
     */
 ...
 */
export const RoleApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const RoleApiClientNavigationMetadata: Record<Exclude<keyof RoleApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
