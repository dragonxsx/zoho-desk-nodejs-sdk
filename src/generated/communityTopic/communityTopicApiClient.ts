 ...
 */
export interface CommunityTopicApiClient extends BaseRequestBuilder<CommunityTopicApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link CommunityTopicApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createCommunityTopicApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<CommunityTopicApiClient>(requestAdapter, pathParameters, CommunityTopicApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const CommunityTopicApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const CommunityTopicApiClientNavigationMetadata: Record<Exclude<keyof CommunityTopicApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
