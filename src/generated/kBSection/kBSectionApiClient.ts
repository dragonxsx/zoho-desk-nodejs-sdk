...
/**
 * Instantiates a new {@link KBSectionApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createKBSectionApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<KBSectionApiClient>(requestAdapter, pathParameters, KBSectionApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface KBSectionApiClient extends BaseRequestBuilder<KBSectionApiClient> {
    /**
     * The api property
     */
 ...
 */
export const KBSectionApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const KBSectionApiClientNavigationMetadata: Record<Exclude<keyof KBSectionApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
