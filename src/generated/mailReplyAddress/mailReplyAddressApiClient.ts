...
/**
 * Instantiates a new {@link MailReplyAddressApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createMailReplyAddressApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<MailReplyAddressApiClient>(requestAdapter, pathParameters, MailReplyAddressApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface MailReplyAddressApiClient extends BaseRequestBuilder<MailReplyAddressApiClient> {
    /**
     * The api property
     */
 ...
 */
export const MailReplyAddressApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const MailReplyAddressApiClientNavigationMetadata: Record<Exclude<keyof MailReplyAddressApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
