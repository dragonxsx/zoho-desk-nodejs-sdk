...
/**
 * Instantiates a new {@link TicketTimerApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createTicketTimerApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<TicketTimerApiClient>(requestAdapter, pathParameters, TicketTimerApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface TicketTimerApiClient extends BaseRequestBuilder<TicketTimerApiClient> {
    /**
     * The api property
     */
 ...
 */
export const TicketTimerApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const TicketTimerApiClientNavigationMetadata: Record<Exclude<keyof TicketTimerApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
