 ...
 */
export interface BugIntegApiClient extends BaseRequestBuilder<BugIntegApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link BugIntegApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createBugIntegApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<BugIntegApiClient>(requestAdapter, pathParameters, BugIntegApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const BugIntegApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const BugIntegApiClientNavigationMetadata: Record<Exclude<keyof BugIntegApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
