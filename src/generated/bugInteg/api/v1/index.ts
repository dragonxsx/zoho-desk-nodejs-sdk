...
// @ts-ignore
import { BugRequestBuilderNavigationMetadata, type BugRequestBuilder } from './bug/index.js';
// @ts-ignore
...
export const V1RequestBuilderNavigationMetadata: Record<Exclude<keyof V1RequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    bug: {
        navigationMetadata: BugRequestBuilderNavigationMetadata,
    },
};
/* tslint:enable */
/* eslint-enable */
