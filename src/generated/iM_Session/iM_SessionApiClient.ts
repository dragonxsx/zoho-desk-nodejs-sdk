...
/**
 * Instantiates a new {@link IM_SessionApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createIM_SessionApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<IM_SessionApiClient>(requestAdapter, pathParameters, IM_SessionApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface IM_SessionApiClient extends BaseRequestBuilder<IM_SessionApiClient> {
    /**
     * The api property
     */
 ...
 */
export const IM_SessionApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const IM_SessionApiClientNavigationMetadata: Record<Exclude<keyof IM_SessionApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
