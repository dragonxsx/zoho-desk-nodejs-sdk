 ...
 */
export interface CommunityCommentApiClient extends BaseRequestBuilder<CommunityCommentApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link CommunityCommentApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createCommunityCommentApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<CommunityCommentApiClient>(requestAdapter, pathParameters, CommunityCommentApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const CommunityCommentApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const CommunityCommentApiClientNavigationMetadata: Record<Exclude<keyof CommunityCommentApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
