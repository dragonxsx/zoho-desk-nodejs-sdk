...
/**
 * Instantiates a new {@link FinanceApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createFinanceApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<FinanceApiClient>(requestAdapter, pathParameters, FinanceApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface FinanceApiClient extends BaseRequestBuilder<FinanceApiClient> {
    /**
     * The api property
     */
 ...
 */
export const FinanceApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const FinanceApiClientNavigationMetadata: Record<Exclude<keyof FinanceApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
