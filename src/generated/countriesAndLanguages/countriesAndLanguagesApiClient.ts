 ...
 */
export interface CountriesAndLanguagesApiClient extends BaseRequestBuilder<CountriesAndLanguagesApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link CountriesAndLanguagesApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createCountriesAndLanguagesApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<CountriesAndLanguagesApiClient>(requestAdapter, pathParameters, CountriesAndLanguagesApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const CountriesAndLanguagesApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const CountriesAndLanguagesApiClientNavigationMetadata: Record<Exclude<keyof CountriesAndLanguagesApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
