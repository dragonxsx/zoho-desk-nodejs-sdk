...
/**
 * Instantiates a new {@link SkillApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createSkillApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<SkillApiClient>(requestAdapter, pathParameters, SkillApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface SkillApiClient extends BaseRequestBuilder<SkillApiClient> {
    /**
     * The api property
     */
 ...
 */
export const SkillApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const SkillApiClientNavigationMetadata: Record<Exclude<keyof SkillApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
