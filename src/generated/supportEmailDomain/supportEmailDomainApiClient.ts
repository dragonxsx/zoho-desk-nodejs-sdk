...
/**
 * Instantiates a new {@link SupportEmailDomainApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createSupportEmailDomainApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<SupportEmailDomainApiClient>(requestAdapter, pathParameters, SupportEmailDomainApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface SupportEmailDomainApiClient extends BaseRequestBuilder<SupportEmailDomainApiClient> {
    /**
     * The api property
     */
 ...
 */
export const SupportEmailDomainApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const SupportEmailDomainApiClientNavigationMetadata: Record<Exclude<keyof SupportEmailDomainApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
