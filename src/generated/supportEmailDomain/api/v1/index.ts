...
// @ts-ignore
import { SupportEmailDomainRequestBuilderRequestsMetadata, type SupportEmailDomainRequestBuilder } from './supportEmailDomain/index.js';
// @ts-ignore
...
export interface V1RequestBuilder extends BaseRequestBuilder<V1RequestBuilder> {
     ...
     */
    get supportEmailDomain(): SupportEmailDomainRequestBuilder;
}
/**
...
export const V1RequestBuilderNavigationMetadata: Record<Exclude<keyof V1RequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    supportEmailDomain: {
        requestsMetadata: SupportEmailDomainRequestBuilderRequestsMetadata,
    },
};
/* tslint:enable */
/* eslint-enable */
