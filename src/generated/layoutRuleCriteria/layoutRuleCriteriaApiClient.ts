...
/**
 * Instantiates a new {@link LayoutRuleCriteriaApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createLayoutRuleCriteriaApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<LayoutRuleCriteriaApiClient>(requestAdapter, pathParameters, LayoutRuleCriteriaApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface LayoutRuleCriteriaApiClient extends BaseRequestBuilder<LayoutRuleCriteriaApiClient> {
    /**
     * The api property
     */
 ...
 */
export const LayoutRuleCriteriaApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const LayoutRuleCriteriaApiClientNavigationMetadata: Record<Exclude<keyof LayoutRuleCriteriaApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
