...
/**
 * Instantiates a new {@link TemplateFoldersApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createTemplateFoldersApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<TemplateFoldersApiClient>(requestAdapter, pathParameters, TemplateFoldersApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface TemplateFoldersApiClient extends BaseRequestBuilder<TemplateFoldersApiClient> {
    /**
     * The api property
     */
 ...
 */
export const TemplateFoldersApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const TemplateFoldersApiClientNavigationMetadata: Record<Exclude<keyof TemplateFoldersApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
