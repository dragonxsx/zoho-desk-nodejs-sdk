...
/**
 * Instantiates a new {@link IM_MetricsApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createIM_MetricsApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<IM_MetricsApiClient>(requestAdapter, pathParameters, IM_MetricsApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface IM_MetricsApiClient extends BaseRequestBuilder<IM_MetricsApiClient> {
    /**
     * The api property
     */
 ...
 */
export const IM_MetricsApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const IM_MetricsApiClientNavigationMetadata: Record<Exclude<keyof IM_MetricsApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
