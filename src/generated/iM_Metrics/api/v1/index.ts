...
// @ts-ignore
import { ImRequestBuilderNavigationMetadata, type ImRequestBuilder } from './im/index.js';
// @ts-ignore
...
export const V1RequestBuilderNavigationMetadata: Record<Exclude<keyof V1RequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    im: {
        navigationMetadata: ImRequestBuilderNavigationMetadata,
    },
};
/* tslint:enable */
/* eslint-enable */
