...
/**
 * Instantiates a new {@link PermalinkApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createPermalinkApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<PermalinkApiClient>(requestAdapter, pathParameters, PermalinkApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface PermalinkApiClient extends BaseRequestBuilder<PermalinkApiClient> {
    /**
     * The api property
     */
 ...
 */
export const PermalinkApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const PermalinkApiClientNavigationMetadata: Record<Exclude<keyof PermalinkApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
