 ...
 */
export interface ChannelApiClient extends BaseRequestBuilder<ChannelApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link ChannelApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createChannelApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<ChannelApiClient>(requestAdapter, pathParameters, ChannelApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const ChannelApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const ChannelApiClientNavigationMetadata: Record<Exclude<keyof ChannelApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
