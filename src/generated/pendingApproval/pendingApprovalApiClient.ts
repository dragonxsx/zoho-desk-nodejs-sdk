...
/**
 * Instantiates a new {@link PendingApprovalApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createPendingApprovalApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<PendingApprovalApiClient>(requestAdapter, pathParameters, PendingApprovalApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface PendingApprovalApiClient extends BaseRequestBuilder<PendingApprovalApiClient> {
    /**
     * The api property
     */
 ...
 */
export const PendingApprovalApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const PendingApprovalApiClientNavigationMetadata: Record<Exclude<keyof PendingApprovalApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
