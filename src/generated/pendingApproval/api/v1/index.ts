...
// @ts-ignore
import { MyPendingApprovalsRequestBuilderRequestsMetadata, type MyPendingApprovalsRequestBuilder } from './myPendingApprovals/index.js';
// @ts-ignore
...
export interface V1RequestBuilder extends BaseRequestBuilder<V1RequestBuilder> {
     ...
     */
    get myPendingApprovals(): MyPendingApprovalsRequestBuilder;
}
/**
...
export const V1RequestBuilderNavigationMetadata: Record<Exclude<keyof V1RequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    myPendingApprovals: {
        requestsMetadata: MyPendingApprovalsRequestBuilderRequestsMetadata,
    },
};
/* tslint:enable */
/* eslint-enable */
