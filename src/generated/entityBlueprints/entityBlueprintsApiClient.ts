...
/**
 * Instantiates a new {@link EntityBlueprintsApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createEntityBlueprintsApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<EntityBlueprintsApiClient>(requestAdapter, pathParameters, EntityBlueprintsApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface EntityBlueprintsApiClient extends BaseRequestBuilder<EntityBlueprintsApiClient> {
    /**
     * The api property
     */
 ...
 */
export const EntityBlueprintsApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const EntityBlueprintsApiClientNavigationMetadata: Record<Exclude<keyof EntityBlueprintsApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
