...
/**
 * Instantiates a new {@link WebhookApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createWebhookApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<WebhookApiClient>(requestAdapter, pathParameters, WebhookApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface WebhookApiClient extends BaseRequestBuilder<WebhookApiClient> {
    /**
     * The api property
     */
 ...
 */
export const WebhookApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const WebhookApiClientNavigationMetadata: Record<Exclude<keyof WebhookApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
