...
/**
 * Instantiates a new {@link HolidayListApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createHolidayListApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<HolidayListApiClient>(requestAdapter, pathParameters, HolidayListApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface HolidayListApiClient extends BaseRequestBuilder<HolidayListApiClient> {
    /**
     * The api property
     */
 ...
 */
export const HolidayListApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const HolidayListApiClientNavigationMetadata: Record<Exclude<keyof HolidayListApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
