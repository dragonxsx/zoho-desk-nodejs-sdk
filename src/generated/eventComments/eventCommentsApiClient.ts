...
/**
 * Instantiates a new {@link EventCommentsApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createEventCommentsApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<EventCommentsApiClient>(requestAdapter, pathParameters, EventCommentsApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface EventCommentsApiClient extends BaseRequestBuilder<EventCommentsApiClient> {
    /**
     * The api property
     */
 ...
 */
export const EventCommentsApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const EventCommentsApiClientNavigationMetadata: Record<Exclude<keyof EventCommentsApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
