 ...
 */
export interface ContactApiClient extends BaseRequestBuilder<ContactApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link ContactApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createContactApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<ContactApiClient>(requestAdapter, pathParameters, ContactApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const ContactApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const ContactApiClientNavigationMetadata: Record<Exclude<keyof ContactApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
