 ...
 */
export interface AutomationFeatureCountApiClient extends BaseRequestBuilder<AutomationFeatureCountApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link AutomationFeatureCountApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createAutomationFeatureCountApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<AutomationFeatureCountApiClient>(requestAdapter, pathParameters, AutomationFeatureCountApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const AutomationFeatureCountApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const AutomationFeatureCountApiClientNavigationMetadata: Record<Exclude<keyof AutomationFeatureCountApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
