...
// @ts-ignore
import { AutomationFeatureCountRequestBuilderRequestsMetadata, type AutomationFeatureCountRequestBuilder } from './automationFeatureCount/index.js';
// @ts-ignore
...
export interface V1RequestBuilder extends BaseRequestBuilder<V1RequestBuilder> {
    /**
     * The automationFeatureCount property
     */
    get automationFeatureCount(): AutomationFeatureCountRequestBuilder;
}
/**
...
export const V1RequestBuilderNavigationMetadata: Record<Exclude<keyof V1RequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    automationFeatureCount: {
        requestsMetadata: AutomationFeatureCountRequestBuilderRequestsMetadata,
    },
};
/* tslint:enable */
/* eslint-enable */
