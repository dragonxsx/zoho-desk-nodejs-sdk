...
/**
 * Instantiates a new {@link TimeTrackingApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createTimeTrackingApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<TimeTrackingApiClient>(requestAdapter, pathParameters, TimeTrackingApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface TimeTrackingApiClient extends BaseRequestBuilder<TimeTrackingApiClient> {
    /**
     * The api property
     */
 ...
 */
export const TimeTrackingApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const TimeTrackingApiClientNavigationMetadata: Record<Exclude<keyof TimeTrackingApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
