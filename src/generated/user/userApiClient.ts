...
/**
 * Instantiates a new {@link UserApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createUserApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<UserApiClient>(requestAdapter, pathParameters, UserApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface UserApiClient extends BaseRequestBuilder<UserApiClient> {
    /**
     * The api property
     */
 ...
 */
export const UserApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const UserApiClientNavigationMetadata: Record<Exclude<keyof UserApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
