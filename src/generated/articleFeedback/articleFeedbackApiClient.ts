 ...
 */
export interface ArticleFeedbackApiClient extends BaseRequestBuilder<ArticleFeedbackApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link ArticleFeedbackApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createArticleFeedbackApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<ArticleFeedbackApiClient>(requestAdapter, pathParameters, ArticleFeedbackApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const ArticleFeedbackApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const ArticleFeedbackApiClientNavigationMetadata: Record<Exclude<keyof ArticleFeedbackApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
