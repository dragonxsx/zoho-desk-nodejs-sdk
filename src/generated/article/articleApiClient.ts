 ...
 */
export interface ArticleApiClient extends BaseRequestBuilder<ArticleApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link ArticleApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createArticleApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<ArticleApiClient>(requestAdapter, pathParameters, ArticleApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const ArticleApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const ArticleApiClientNavigationMetadata: Record<Exclude<keyof ArticleApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
