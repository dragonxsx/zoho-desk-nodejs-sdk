 ...
 */
export interface CommunityPreferencesApiClient extends BaseRequestBuilder<CommunityPreferencesApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link CommunityPreferencesApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createCommunityPreferencesApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<CommunityPreferencesApiClient>(requestAdapter, pathParameters, CommunityPreferencesApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const CommunityPreferencesApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const CommunityPreferencesApiClientNavigationMetadata: Record<Exclude<keyof CommunityPreferencesApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
