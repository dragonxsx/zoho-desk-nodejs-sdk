 ...
 */
export interface ContactDeduplicationApiClient extends BaseRequestBuilder<ContactDeduplicationApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link ContactDeduplicationApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createContactDeduplicationApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<ContactDeduplicationApiClient>(requestAdapter, pathParameters, ContactDeduplicationApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const ContactDeduplicationApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const ContactDeduplicationApiClientNavigationMetadata: Record<Exclude<keyof ContactDeduplicationApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
