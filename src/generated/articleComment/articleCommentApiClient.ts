 ...
 */
export interface ArticleCommentApiClient extends BaseRequestBuilder<ArticleCommentApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link ArticleCommentApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createArticleCommentApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<ArticleCommentApiClient>(requestAdapter, pathParameters, ArticleCommentApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const ArticleCommentApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const ArticleCommentApiClientNavigationMetadata: Record<Exclude<keyof ArticleCommentApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
