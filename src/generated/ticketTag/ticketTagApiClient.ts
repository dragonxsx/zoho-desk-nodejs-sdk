...
/**
 * Instantiates a new {@link TicketTagApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createTicketTagApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<TicketTagApiClient>(requestAdapter, pathParameters, TicketTagApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface TicketTagApiClient extends BaseRequestBuilder<TicketTagApiClient> {
    /**
     * The api property
     */
 ...
 */
export const TicketTagApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const TicketTagApiClientNavigationMetadata: Record<Exclude<keyof TicketTagApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
