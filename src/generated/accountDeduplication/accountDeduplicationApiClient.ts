 ...
 */
export interface AccountDeduplicationApiClient extends BaseRequestBuilder<AccountDeduplicationApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link AccountDeduplicationApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createAccountDeduplicationApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<AccountDeduplicationApiClient>(requestAdapter, pathParameters, AccountDeduplicationApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const AccountDeduplicationApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const AccountDeduplicationApiClientNavigationMetadata: Record<Exclude<keyof AccountDeduplicationApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
