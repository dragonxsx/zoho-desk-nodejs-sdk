...
/**
 * Instantiates a new {@link DashboardMetricsApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createDashboardMetricsApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<DashboardMetricsApiClient>(requestAdapter, pathParameters, DashboardMetricsApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface DashboardMetricsApiClient extends BaseRequestBuilder<DashboardMetricsApiClient> {
    /**
     * The api property
     */
 ...
 */
export const DashboardMetricsApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const DashboardMetricsApiClientNavigationMetadata: Record<Exclude<keyof DashboardMetricsApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
