...
/**
 * Instantiates a new {@link LicenseFeaturePlanApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createLicenseFeaturePlanApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<LicenseFeaturePlanApiClient>(requestAdapter, pathParameters, LicenseFeaturePlanApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface LicenseFeaturePlanApiClient extends BaseRequestBuilder<LicenseFeaturePlanApiClient> {
    /**
     * The api property
     */
 ...
 */
export const LicenseFeaturePlanApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const LicenseFeaturePlanApiClientNavigationMetadata: Record<Exclude<keyof LicenseFeaturePlanApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
