...
/**
 * Instantiates a new {@link OrganizationApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createOrganizationApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<OrganizationApiClient>(requestAdapter, pathParameters, OrganizationApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface OrganizationApiClient extends BaseRequestBuilder<OrganizationApiClient> {
    /**
     * The api property
     */
 ...
 */
export const OrganizationApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const OrganizationApiClientNavigationMetadata: Record<Exclude<keyof OrganizationApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
