...
/**
 * Instantiates a new {@link TicketTemplateApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createTicketTemplateApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<TicketTemplateApiClient>(requestAdapter, pathParameters, TicketTemplateApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface TicketTemplateApiClient extends BaseRequestBuilder<TicketTemplateApiClient> {
    /**
     * The api property
     */
 ...
 */
export const TicketTemplateApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const TicketTemplateApiClientNavigationMetadata: Record<Exclude<keyof TicketTemplateApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
