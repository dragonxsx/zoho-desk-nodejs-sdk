...
/**
 * Instantiates a new {@link ValidationRulesApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createValidationRulesApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<ValidationRulesApiClient>(requestAdapter, pathParameters, ValidationRulesApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface ValidationRulesApiClient extends BaseRequestBuilder<ValidationRulesApiClient> {
    /**
     * The api property
     */
 ...
 */
export const ValidationRulesApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const ValidationRulesApiClientNavigationMetadata: Record<Exclude<keyof ValidationRulesApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
