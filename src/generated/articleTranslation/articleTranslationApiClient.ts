 ...
 */
export interface ArticleTranslationApiClient extends BaseRequestBuilder<ArticleTranslationApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link ArticleTranslationApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createArticleTranslationApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<ArticleTranslationApiClient>(requestAdapter, pathParameters, ArticleTranslationApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const ArticleTranslationApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const ArticleTranslationApiClientNavigationMetadata: Record<Exclude<keyof ArticleTranslationApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
