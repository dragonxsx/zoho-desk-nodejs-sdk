 ...
 */
export interface ContactFollowersApiClient extends BaseRequestBuilder<ContactFollowersApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link ContactFollowersApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createContactFollowersApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<ContactFollowersApiClient>(requestAdapter, pathParameters, ContactFollowersApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const ContactFollowersApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const ContactFollowersApiClientNavigationMetadata: Record<Exclude<keyof ContactFollowersApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
