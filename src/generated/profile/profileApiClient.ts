...
/**
 * Instantiates a new {@link ProfileApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createProfileApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<ProfileApiClient>(requestAdapter, pathParameters, ProfileApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface ProfileApiClient extends BaseRequestBuilder<ProfileApiClient> {
    /**
     * The api property
     */
 ...
 */
export const ProfileApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const ProfileApiClientNavigationMetadata: Record<Exclude<keyof ProfileApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
