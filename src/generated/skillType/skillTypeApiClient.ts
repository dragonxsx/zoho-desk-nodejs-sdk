...
/**
 * Instantiates a new {@link SkillTypeApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createSkillTypeApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<SkillTypeApiClient>(requestAdapter, pathParameters, SkillTypeApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface SkillTypeApiClient extends BaseRequestBuilder<SkillTypeApiClient> {
    /**
     * The api property
     */
 ...
 */
export const SkillTypeApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const SkillTypeApiClientNavigationMetadata: Record<Exclude<keyof SkillTypeApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
