...
/**
 * Instantiates a new {@link EventApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createEventApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<EventApiClient>(requestAdapter, pathParameters, EventApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface EventApiClient extends BaseRequestBuilder<EventApiClient> {
    /**
     * The api property
     */
 ...
 */
export const EventApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const EventApiClientNavigationMetadata: Record<Exclude<keyof EventApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
