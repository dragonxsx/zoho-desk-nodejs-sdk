 ...
 */
export interface AgentSignaturesApiClient extends BaseRequestBuilder<AgentSignaturesApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link AgentSignaturesApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createAgentSignaturesApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<AgentSignaturesApiClient>(requestAdapter, pathParameters, AgentSignaturesApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const AgentSignaturesApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const AgentSignaturesApiClientNavigationMetadata: Record<Exclude<keyof AgentSignaturesApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
