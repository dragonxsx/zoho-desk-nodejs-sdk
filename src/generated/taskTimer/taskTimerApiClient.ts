...
/**
 * Instantiates a new {@link TaskTimerApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createTaskTimerApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<TaskTimerApiClient>(requestAdapter, pathParameters, TaskTimerApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface TaskTimerApiClient extends BaseRequestBuilder<TaskTimerApiClient> {
    /**
     * The api property
     */
 ...
 */
export const TaskTimerApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const TaskTimerApiClientNavigationMetadata: Record<Exclude<keyof TaskTimerApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
