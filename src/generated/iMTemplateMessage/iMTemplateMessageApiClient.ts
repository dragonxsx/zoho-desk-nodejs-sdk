...
/**
 * Instantiates a new {@link IMTemplateMessageApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createIMTemplateMessageApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<IMTemplateMessageApiClient>(requestAdapter, pathParameters, IMTemplateMessageApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface IMTemplateMessageApiClient extends BaseRequestBuilder<IMTemplateMessageApiClient> {
    /**
     * The api property
     */
 ...
 */
export const IMTemplateMessageApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const IMTemplateMessageApiClientNavigationMetadata: Record<Exclude<keyof IMTemplateMessageApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
