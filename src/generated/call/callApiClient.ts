 ...
 */
export interface CallApiClient extends BaseRequestBuilder<CallApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link CallApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createCallApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<CallApiClient>(requestAdapter, pathParameters, CallApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const CallApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const CallApiClientNavigationMetadata: Record<Exclude<keyof CallApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
