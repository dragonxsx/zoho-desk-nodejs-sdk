 ...
 */
export interface AccountContactMappingInfoApiClient extends BaseRequestBuilder<AccountContactMappingInfoApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link AccountContactMappingInfoApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createAccountContactMappingInfoApiClient(requestAdapter: RequestAdapter) {
    ...
    if (requestAdapter.baseUrl === undefined || requestAdapter.baseUrl === null || requestAdapter.baseUrl === "") {
        requestAdapter.baseUrl = "https://desk.zoho.com";
    }
    const pathParameters: Record<string, unknown> = {
        "baseurl": requestAdapter.baseUrl,
    };
    return apiClientProxifier<AccountContactMappingInfoApiClient>(requestAdapter, pathParameters, AccountContactMappingInfoApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const AccountContactMappingInfoApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const AccountContactMappingInfoApiClientNavigationMetadata: Record<Exclude<keyof AccountContactMappingInfoApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
