...
// @ts-ignore
import { AccountContactMappingRequestBuilderNavigationMetadata, type AccountContactMappingRequestBuilder } from './accountContactMapping/index.js';
// @ts-ignore
...
export interface V1RequestBuilder extends BaseRequestBuilder<V1RequestBuilder> {
    /**
     * The accountContactMapping property
     */
    get accountContactMapping(): AccountContactMappingRequestBuilder;
}
/**
...
export const V1RequestBuilderNavigationMetadata: Record<Exclude<keyof V1RequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    accountContactMapping: {
        navigationMetadata: AccountContactMappingRequestBuilderNavigationMetadata,
    },
};
/* tslint:enable */
/* eslint-enable */
