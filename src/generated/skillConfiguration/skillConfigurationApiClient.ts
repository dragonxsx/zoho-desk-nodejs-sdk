...
/**
 * Instantiates a new {@link SkillConfigurationApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createSkillConfigurationApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<SkillConfigurationApiClient>(requestAdapter, pathParameters, SkillConfigurationApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface SkillConfigurationApiClient extends BaseRequestBuilder<SkillConfigurationApiClient> {
    /**
     * The api property
     */
 ...
 */
export const SkillConfigurationApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const SkillConfigurationApiClientNavigationMetadata: Record<Exclude<keyof SkillConfigurationApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
