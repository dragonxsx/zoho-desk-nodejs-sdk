...
/**
 * Instantiates a new {@link CustomViewApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createCustomViewApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<CustomViewApiClient>(requestAdapter, pathParameters, CustomViewApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface CustomViewApiClient extends BaseRequestBuilder<CustomViewApiClient> {
    /**
     * The api property
     */
 ...
 */
export const CustomViewApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const CustomViewApiClientNavigationMetadata: Record<Exclude<keyof CustomViewApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
