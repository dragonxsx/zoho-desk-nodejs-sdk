...
/**
 * Instantiates a new {@link GenericActionApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createGenericActionApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<GenericActionApiClient>(requestAdapter, pathParameters, GenericActionApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface GenericActionApiClient extends BaseRequestBuilder<GenericActionApiClient> {
    /**
     * The api property
     */
 ...
 */
export const GenericActionApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const GenericActionApiClientNavigationMetadata: Record<Exclude<keyof GenericActionApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
