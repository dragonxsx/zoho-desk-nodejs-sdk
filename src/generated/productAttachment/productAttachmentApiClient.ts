...
/**
 * Instantiates a new {@link ProductAttachmentApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createProductAttachmentApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<ProductAttachmentApiClient>(requestAdapter, pathParameters, ProductAttachmentApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface ProductAttachmentApiClient extends BaseRequestBuilder<ProductAttachmentApiClient> {
    /**
     * The api property
     */
 ...
 */
export const ProductAttachmentApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const ProductAttachmentApiClientNavigationMetadata: Record<Exclude<keyof ProductAttachmentApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
