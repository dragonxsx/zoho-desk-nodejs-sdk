 ...
 */
export interface BadgeApiClient extends BaseRequestBuilder<BadgeApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link BadgeApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createBadgeApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<BadgeApiClient>(requestAdapter, pathParameters, BadgeApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const BadgeApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const BadgeApiClientNavigationMetadata: Record<Exclude<keyof BadgeApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
