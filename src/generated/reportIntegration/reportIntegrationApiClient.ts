...
/**
 * Instantiates a new {@link ReportIntegrationApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createReportIntegrationApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<ReportIntegrationApiClient>(requestAdapter, pathParameters, ReportIntegrationApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface ReportIntegrationApiClient extends BaseRequestBuilder<ReportIntegrationApiClient> {
    /**
     * The api property
     */
 ...
 */
export const ReportIntegrationApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const ReportIntegrationApiClientNavigationMetadata: Record<Exclude<keyof ReportIntegrationApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
