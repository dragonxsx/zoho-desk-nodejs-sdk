 ...
 */
export interface BlueprintTransitionsApiClient extends BaseRequestBuilder<BlueprintTransitionsApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link BlueprintTransitionsApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createBlueprintTransitionsApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<BlueprintTransitionsApiClient>(requestAdapter, pathParameters, BlueprintTransitionsApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const BlueprintTransitionsApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const BlueprintTransitionsApiClientNavigationMetadata: Record<Exclude<keyof BlueprintTransitionsApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
