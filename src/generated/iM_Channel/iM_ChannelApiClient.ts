...
/**
 * Instantiates a new {@link IM_ChannelApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createIM_ChannelApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<IM_ChannelApiClient>(requestAdapter, pathParameters, IM_ChannelApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface IM_ChannelApiClient extends BaseRequestBuilder<IM_ChannelApiClient> {
    /**
     * The api property
     */
 ...
 */
export const IM_ChannelApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const IM_ChannelApiClientNavigationMetadata: Record<Exclude<keyof IM_ChannelApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
