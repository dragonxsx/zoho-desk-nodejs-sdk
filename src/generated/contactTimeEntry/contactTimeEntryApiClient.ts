 ...
 */
export interface ContactTimeEntryApiClient extends BaseRequestBuilder<ContactTimeEntryApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link ContactTimeEntryApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createContactTimeEntryApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<ContactTimeEntryApiClient>(requestAdapter, pathParameters, ContactTimeEntryApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const ContactTimeEntryApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const ContactTimeEntryApiClientNavigationMetadata: Record<Exclude<keyof ContactTimeEntryApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
