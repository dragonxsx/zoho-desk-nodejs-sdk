...
/**
 * Instantiates a new {@link TaskCommentsApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createTaskCommentsApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<TaskCommentsApiClient>(requestAdapter, pathParameters, TaskCommentsApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface TaskCommentsApiClient extends BaseRequestBuilder<TaskCommentsApiClient> {
    /**
     * The api property
     */
 ...
 */
export const TaskCommentsApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const TaskCommentsApiClientNavigationMetadata: Record<Exclude<keyof TaskCommentsApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
