...
/**
 * Instantiates a new {@link TicketApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createTicketApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<TicketApiClient>(requestAdapter, pathParameters, TicketApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface TicketApiClient extends BaseRequestBuilder<TicketApiClient> {
    /**
     * The api property
     */
 ...
 */
export const TicketApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const TicketApiClientNavigationMetadata: Record<Exclude<keyof TicketApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
