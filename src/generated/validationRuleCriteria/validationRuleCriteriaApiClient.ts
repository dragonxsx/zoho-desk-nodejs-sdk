...
/**
 * Instantiates a new {@link ValidationRuleCriteriaApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createValidationRuleCriteriaApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<ValidationRuleCriteriaApiClient>(requestAdapter, pathParameters, ValidationRuleCriteriaApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface ValidationRuleCriteriaApiClient extends BaseRequestBuilder<ValidationRuleCriteriaApiClient> {
    /**
     * The api property
     */
 ...
 */
export const ValidationRuleCriteriaApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const ValidationRuleCriteriaApiClientNavigationMetadata: Record<Exclude<keyof ValidationRuleCriteriaApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
